...
// useReducer : react에 복잡한 생태관리를 더 체계적으로 예측 가능하게 처리하기 위한 상태관리 Hook
//              useState의 대체제이며, 상태관리 변화의 로직이 복합할때 사용하면
//              더 명확하고 깔급하게 관리 할 수 있다.
...
// export default function UseReducerTest01(params) {
//     const [count, setCount] = useState(5);
//     const handleIncretment = () =>{
//         setCount(count + 1 ) ;
//     }
//     const handleDecretment = () =>{
//         setCount(count - 1 ) ;
//     }
//     const handleReset = () =>{
//         setCount(5) ;
...
//         <div>
//             <h2>Count : {count}</h2>
//             <button onClick={handleIncretment}> + </button>
//             <button onClick={handleDecretment}> - </button>
